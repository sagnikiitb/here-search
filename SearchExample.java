...
/*
    public String autoSuggestExample(String hint) {
        ...
        return searchEngine.suggest(
                new TextQuery(hint, // User typed "p".
                        queryArea),
                searchOptions,
                autosuggestCallback).toString();
/*
